...
export default function Team() {
    return (
        <section className="bg-white py-20 md:py-[100px] xl:pt-[120px] xl:pb-[180px]">
            <Container>
                <div className="w-11/12 sm:w-8/12 xl:max-w-[674px] mx-auto">
                ...
                <div className="max-w-[300px] sm:max-w-full sm:w-6/12 md:w-10/12 lg:w-8/12 xl:w-full mx-auto grid md:grid-cols-2 xl:grid-cols-4 gap-6 md:gap-5 xl:gap-6 mt-10 md:mt-[60px] relative">
                    {
                    ...
                    <Image className="w-[51px] absolute left-[-52px] hidden xl:block xl:bottom-[-20%]" src={HalfCircle} alt="" width={51} height={51} />
                    <Image className="w-[65px] absolute right-[-35px] top-[-56px]  hidden xl:block" src={Spring} alt="" width={65} height={56} />
                </div>
            </Container>
        </section>
    );
